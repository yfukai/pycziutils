...
#>
function lint() {
    poetry run flake8 src\pycziutils tests
}
...
#>
function docs(){
    if (Test-Path ".\docs\pycziutils.rst") { Remove-Item ".\docs\pycziutils.rst" -Force }
    if (Test-Path ".\docs\modules.rst") { Remove-Item ".\docs\modules.rst" -Force }
    poetry run sphinx-apidoc -o docs\ src\pycziutils
